...
def simulate_streamed_timeseries_as_df(duration):
    """
    Simulates a timeseries stream of dB values over a specified duration and writes df to parquet

    :param duration: The duration of the timeseries in seconds.
    :type duration: int
    :return: The generated timeseries as pandas dataframe, with timestamp and dB value.
    :rtype: df[(datetime, int)]
    """
